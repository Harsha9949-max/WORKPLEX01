      ...
      if (productForm.id) {
          ...
          for (const shopDoc of shopsQuery.docs) {
               ...
               if (!partnerProdSnap.empty) {
                   ...
                   batch.set(partnerProdRef, {
                       ...
                       partnerMargin: customSellingPrice - (payload.suggestedRetailPrice || payload.hvrsBasePrice),
        ...
        for (const shopDoc of shopsQuery.docs) {
             ...
             batch.set(partnerProdRef, {
                 ...
                 hvrsBasePrice: payload.hvrsBasePrice,
                 suggestedRetailPrice: payload.suggestedRetailPrice || payload.hvrsBasePrice,
                 partnerSellingPrice: (payload.suggestedRetailPrice || payload.hvrsBasePrice) + 100,
                 partnerMargin: 100,
                 category: payload.category || 'General',
                 description: payload.description || '',
