  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg p-4 h-48 overflow-y-auto text-sm text-gray-300 space-y-3 custom-scrollbar">
        ...
        <p>
          <strong>2. Compensation:</strong> Contractor will be paid based on completed missions and commissions. A welcome incentive is credited to the pending wallet upon signup and unlocks after the first verified task.
        </p>
        <p>
